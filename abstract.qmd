...
viz <- ggplot(plot_data, aes(x = time_of_day_bin, y = mean_likes, 
  ...
  scale_y_continuous(breaks = seq(0, 60000, 
                                 by = 10000)) +
  labs(
    x      = "Time of Day",
    y      = "Number of Likes",
...
grid.arrange(viz, top = "Figure 1: Engagement Patterns Across Time-of-Day and Post Type")
```
